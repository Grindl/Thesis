...
const char* PixelReaderFragmentShader = ".\\Code\\Shaders\\FixedFunctionFBO.fragment.glsl";
const char* PixelReaderVertexShader = ".\\Code\\Shaders\\FixedFunctionFBO.vertex.glsl";


//----------------------------------------------------------------------------------------
RenderToMemoryBuffer::RenderToMemoryBuffer()
{
	...
	m_currentFrameInMemory = new unsigned char[SCREEN_WIDTH*SCREEN_HEIGHT*4];

	m_FBOShader = Shader(PixelReaderVertexShader, PixelReaderFragmentShader);
...
//----------------------------------------------------------------------------------------
void RenderToMemoryBuffer::preRenderStep()
{
	glBindFramebuffer( GL_FRAMEBUFFER, m_frameBufferObject );
}

//----------------------------------------------------------------------------------------
void RenderToMemoryBuffer::postRenderStep()
{
	glReadBuffer(GL_COLOR_ATTACHMENT0);
	
	glReadPixels(0,0,SCREEN_WIDTH, SCREEN_HEIGHT, GL_RGBA, GL_UNSIGNED_BYTE, m_currentFrameInMemory);
