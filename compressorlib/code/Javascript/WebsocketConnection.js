...
//var frameHeight
//var frameWidth
//all inserted in to the stream beforehand with runtime values
    ...
    if ("WebSocket" in window) {
        ...
        ws.onmessage = function (evt) {
            ...
            if (compressionType == "NONE") {
                video.style.display = "none"; //slight hack to deal with the video element
                var currentFrameImageData = canvasContext.createImageData(frameWidth, frameHeight);
                ...
                renderContext.drawImage(canvas, 0, -1 * frameHeight);
                ...
                image.src = imageURL;
                image.style.display = "none";*/ //NOTE: this is dramatically faster on the client side (~2 orders of magnitude) but it doesn't interact properly with the canvas
                renderContext.save();
                renderContext.scale(1, -1);
                renderContext.drawImage(image, 0, -1 * frameHeight);
                renderContext.restore();
            }
